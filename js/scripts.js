const canvas = document.getElementById('outrunCanvas');
    ...
    function generateStars() {
      for (let i = 0; i < starCount; i++) {
        stars.push({
          ...
          baseOpacity: Math.random() * 0.4 + 0.8,
    ...
    function drawStars() {
      ...
      stars.forEach(star => {
        ...
        const opacity = star.baseOpacity * (0.5 + 0.7 * twinkle);
    ...
    function generateMountains() {
      ...
      const mountainConfigs = [
        { layers: 4, chaos: 35, size: 350 * scale, x: centerX - 1350 * scale - 250 * scale, y: midY - 300 * scale, tall: 'left', height: 1, gradient: gradientUno },
        { layers: 4, chaos: 35, size: 350 * scale, x: centerX + 900 * scale, y: midY - 300 * scale, tall: 'right', height: 1, gradient: gradientUno },
        { layers: 3, chaos: 35, size: 600 * scale, x: centerX - 950 * scale - 280 * scale, y: midY - 200 * scale, tall: 'left', height: 0.4, gradient: gradientDuo },
        { layers: 3, chaos: 35, size: 600 * scale, x: centerX + 0 * scale, y: midY - 200 * scale, tall: 'right', height: 0.4, gradient: gradientDuo },
        { layers: 3, chaos: 35, size: 1000 * scale, x: centerX - 1150 * scale - 650 * scale, y: midY - 100 * scale, tall: 'left', height: 0.15, gradient: gradientTre },
        { layers: 3, chaos: 35, size: 1000 * scale, x: centerX - 200 * scale, y: midY - 100 * scale, tall: 'right', height: 0.15, gradient: gradientTre }
      ];
